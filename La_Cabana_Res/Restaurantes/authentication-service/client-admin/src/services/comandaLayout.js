...
export const TEMPLATE_PX = { width: 688 };
export const HEADER_IMAGE_URL = '/comanda-header.jpg';
export const HEADER_HEIGHT_PX = 250;

const MARGIN_X = 40;
const RIGHT_X = TEMPLATE_PX.width - MARGIN_X; // 648

// --- Datos del pedido (Mesero / No. Pedido / Fecha / Mesa) ---
const META_TOP_PX = 280;
const META_LINE_HEIGHT_PX = 44;
export const META_FONT_PX = 17;
...
const COLUMNS_HEADER_TOP_PX = DOTTED_LINE_Y_PX + 24;
export const COLUMNS_HEADER_FONT_PX = 14;

export const COLS_PX = {
  producto: [MARGIN_X, 300],
  cantidad: [300, 410],
  precio: [410, 545],
  total: [545, RIGHT_X],
};
...
const ROWS_TOP_PX = COLUMNS_HEADER_TOP_PX + 44;
export const ROW_HEIGHT_PX = 40;
export const ROW_FONT_PX = 14;

// --- Barra + totales (sin "Descuento": solo Total y A pagar) ---
const BLACK_BAR_HEIGHT_PX = 8;
const TOTALS_GAP_PX = 40;
export const TOTALS_LABEL_FONT_PX = 15;
export const TOTALS_AMOUNT_FONT_PX = 15;
export const A_PAGAR_LABEL_FONT_PX = 15;
export const A_PAGAR_AMOUNT_FONT_PX = 28;
// Alto del bloque de totales (una sola fila: "Total:" a la izquierda y
// "A pagar:" + monto grande a la derecha).
const TOTALS_BLOCK_HEIGHT_PX = 90;

export const OBSERVATIONS_FONT_PX = 11;
