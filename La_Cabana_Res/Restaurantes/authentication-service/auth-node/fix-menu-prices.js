...
const baseItems = [
  ...
  { name: 'Porción de Camarones al Ajillo', category: 'Extras', price: 40, description: 'Porción de camarones al ajillo.' },
  { name: 'Porción de Camarones a la Diabla', category: 'Extras', price: 40, description: 'Porción de camarones a la diabla.' },
  { name: 'Porción de Camarones Empanizados', category: 'Extras', price: 40, description: 'Porción de camarones empanizados.' },
  { name: 'Porción de Camarones Encebollados', category: 'Extras', price: 40, description: 'Porción de camarones encebollados.' },
  ...
  { name: 'Mojarra al Vapor', category: 'Platos Fuertes', price: 110, description: 'Mojarra al vapor según tamaño solicitado.' },
  ...
  { name: 'Alitas en Barbacoa', category: 'Platos Fuertes', price: 60, description: 'Alitas en barbacoa.' },
  { name: 'Alitas Búfalo', category: 'Platos Fuertes', price: 60, description: 'Alitas estilo búfalo.' },
  { name: 'Alitas Empanizadas', category: 'Platos Fuertes', price: 60, description: 'Alitas empanizadas.' },
  ...
  { name: 'LimoSoda', category: 'Bebidas frias', price: 20, description: 'LimoSoda.' },
  { name: 'Naranjada Con Soda', category: 'Bebidas frias', price: 20, description: 'Naranjada con soda.' },
  { name: 'Licuado de Fresa', category: 'Bebidas frias', price: 15, description: 'Licuado de fresa.' },
  { name: 'Cimarrona', category: 'Bebidas frias', price: 25, description: 'Cimarrona.' },
  { name: 'Licuado de Banano', category: 'Bebidas frias', price: 15, description: 'Licuado de banano.' },
  { name: 'Cocacola', category: 'Bebidas frias', price: 10, description: 'Coca-Cola.' },
  { name: 'Sprite', category: 'Bebidas frias', price: 10, description: 'Sprite.' },
  { name: 'Fanta', category: 'Bebidas frias', price: 10, description: 'Fanta.' },
  { name: 'Orange', category: 'Bebidas frias', price: 10, description: 'Orange.' },
  { name: 'Tiki', category: 'Bebidas frias', price: 10, description: 'Tiki.' },
  { name: 'Salvavidas (Soda)', category: 'Bebidas frias', price: 10, description: 'Salvavidas (soda).' },
  { name: 'Mineral (Soda)', category: 'Bebidas frias', price: 10, description: 'Mineral (soda).' },
