...
const seedBaseMenuItems = async () => {
    try {
        const baseItems = [
            ...
            { name: "Porción ajillo", category: "Extras", description: "Porción de camarones al ajillo.", price: 40, available: true },
            { name: "Porción diabla", category: "Extras", description: "Porción de camarones a la diabla.", price: 40, available: true },
            { name: "Porción empanizado", category: "Extras", description: "Porción de camarones empanizados.", price: 40, available: true },
            ...
            { name: "Camarón medio", category: "Platos Fuertes", description: "Media porción de camarones.", price: 40, available: true },
