...
const seedBaseMenuItems = async () => {
    try {
        const baseItems = [
            ...
            { name: "Porción ajillo", category: "Platos Fuertes", description: "Porción de camarones al ajillo.", price: 40, available: true },
            { name: "Porción diabla", category: "Platos Fuertes", description: "Porción de camarones a la diabla.", price: 40, available: true },
            { name: "Porción empanizado", category: "Platos Fuertes", description: "Porción de camarones empanizados.", price: 40, available: true },
            { name: "Porción encebollados", category: "Platos Fuertes", description: "Porción de camarones encebollados.", price: 40, available: true },
            ...
            { name: "Extra", category: "Extras", description: "Cargo extra genérico.", price: 5, available: true },
            ...
            { name: "Mojarra Vapor", category: "Platos Fuertes", description: "Mojarra al vapor según tamaño solicitado.", price: 110, available: true },
            { name: "Mojarra Frita con Camarones", category: "Platos Fuertes", description: "Mojarra con camarones.", price: 150, available: true },
            { name: "Costillas Barbacoa", category: "Platos Fuertes", description: "Costillas en barbacoa.", price: 65, available: true },
            { name: "Alitas Barbacoa", category: "Platos Fuertes", description: "Alitas en barbacoa.", price: 60, available: true },
            { name: "Alitas Búfalo", category: "Platos Fuertes", description: "Alitas estilo búfalo.", price: 60, available: true },
            { name: "Alitas Empanizadas", category: "Platos Fuertes", description: "Alitas empanizadas.", price: 60, available: true },
